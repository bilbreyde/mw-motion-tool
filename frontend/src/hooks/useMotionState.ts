...
const initialState: MotionState = {
  ...
  readinessCheck: {
    ...
    espConfigured: null,
    enrollmentRestrictionsExist: null,
    enrollmentRestrictionsDetail: '',
    provisioningPreference: null,
  ...
  deploymentRecommendation: {
    ...
    appsWithLengthyInstall: null,
    appsWithLengthyInstallDetail: '',
    appsDependOnUserCreds: null,
  ...
  engagementTriggers: {
    ...
    autopilotRegistrationValidator: '',
    shipToLocation: null,
    directToUserShipmentRequired: null,
